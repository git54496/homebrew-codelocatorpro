class AndroidUiGrab < Formula
  ...
  url "https://github.com/git54496/android-ui-grab/archive/refs/tags/v0.2.10.tar.gz"
  version "0.2.10"
  sha256 "d49bc2db386c590faa1e82091be024143268b93f78311e40fd8090216fa9296c"
  license "Apache-2.0"
  version_scheme 1
  ...
  test do
    ...
    assert_equal "0.2.10", version_output
